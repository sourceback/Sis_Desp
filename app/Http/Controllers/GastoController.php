...
use App\Models\Gasto as Modeloprincipal;
...
class GastoController extends Controller
{
    ...
    private $arrRules = [
        'clave' => 'required|string|max:45|unique:gastos',
    ...
    {   
        ...
        foreach($arrRecords as $arrRecord){
            if($arrRecord->tipo == 0){
                $ingreso = $ingreso + $arrRecord->monto; 
            }else{
                $egreso = $egreso + $arrRecord->monto;
            }
        }
        $this->arrInfo['arrIngreso'] = $ingreso;
        $this->arrInfo['arrEgreso'] = $egreso;
