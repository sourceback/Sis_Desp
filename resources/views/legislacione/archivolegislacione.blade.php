    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div col-md-12>		
            <div class="card-body">
	            <div class="container" >
                <form method="post" action="{{ route($arrInfo['ruta'].'.archivolegislacionedo', $arrInfo['arrRecord']['id']) }}" enctype="multipart/form-data" class="dropzone" id="my-awesome-dropzone">
                    @csrf          
                </form>
