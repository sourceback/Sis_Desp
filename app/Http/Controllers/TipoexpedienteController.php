...
use App\Models\Tipoexpediente as Modeloprincipal;
...
class TipoexpedienteController extends Controller
{
    //
    private $arrInfo = [
        'tabla' => 'tipoexpedientes',
        'ruta' => 'tipoexpedientes',
        'llave' => 'tipoexpediente',
        'activo' => '7'
    ];

    private $arrRules = [
        'clave' => 'required|string|max:45|unique:tipoexpedientes',
