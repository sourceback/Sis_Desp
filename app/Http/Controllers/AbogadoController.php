...
use App\Models\Abogado as Modeloprincipal;
...
class AbogadoController extends Controller
{
    ...
    private $arrRules = [
        'clave' => 'required|string|max:45|unique:abogados',
        ...
        'despacho' => 'required|string|max:45',
        'nacionalidad' => 'required|string|max:45',
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $theRecord->despacho = $request->despacho;
            $theRecord->nacionalidad = $request->nacionalidad;
            $theRecord->identificacion = $request->identificacion;
